...
When installing Stevedore via Chocolatey, use this syntax: `choco install stevedore --params="/ADDLOCAL=Feature1,Feature2,Feature3 /INSTALLDIR=c:\custom\path\ /quiet"`
