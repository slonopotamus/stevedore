...
* Update Docker Engine to 29.8.1
* Update Docker Buildx to 0.37.1
* Update containerd to 2.4.0-2-g0648221cd
* Update nerdctl to 2.4.0

== 4.3.0 (2026-09-10)

* Update Docker Engine to 29.8.0
* Update Docker Buildx to 0.37.0
* Update Docker Compose to 5.5.1
* Update BuildKit to 0.33.0

== 4.2.0 (2026-08-27)

* Update Docker Engine to 29.7.2
* Update Docker Buildx to 0.37.0-rc1
* Update Docker Compose to 5.5.0
* Update docker-credential-wincred to 0.9.9
* Update BuildKit to 0.32.2

== 4.1.1 (2026-07-30)

* Update Docker Engine to 29.6.2
* Update Docker Buildx to 0.36.0
* Update Docker Compose to 5.3.1
* Update containerd to 2.3.3-2-gd27132612
* Update nerdctl to 2.3.5
* Update BuildKit to 0.32.0

== 4.0.0 (2026-07-10)

* Temporarily switch to https://github.com/slonopotamus/containerd/releases/tag/v2.3.0-190-gcc602e1b2[containerd fork].

== 3.4.0 (2026-07-06)

* Update Docker Engine to 29.6.1
* Update Docker Buildx to 0.35.0
* Update Docker Compose to 5.3.0
* Update containerd to 2.3.2
* Update nerdctl to 2.3.4
* Update BuildKit to 0.31.1

== 3.3.1 (2026-06-22)

* Switch to `io.containerd.runhcs.v1` runtime by default.
See https://github.com/slonopotamus/stevedore/issues/92[#92].

== 3.3.0 (2026-06-14)

* Upgrade Docker Engine to 29.5.3
* Update Docker Buildx to 0.34.1
* Update Docker Compose to 5.1.4
* Update docker-credential-wincred to 0.9.8
* Update containerd to 2.3.1
* Update nerdctl to 2.3.1
* Update BuildKit to 0.30.0

== 3.2.2 (2026-01-10)

* Upgrade containerd and nerdctl to 2.2.1
* Downgrade Docker Engine to 28.5.1
See https://github.com/slonopotamus/stevedore/issues/92[#92].

== 3.2.1 (2026-01-10)

* Downgrade containerd and nerdctl to 2.1.6.
See https://github.com/slonopotamus/stevedore/issues/92[#92].

== 3.2.0 (2025-12-29)

* Update Docker Engine to 29.1.3
* Update Docker Buildx to 0.30.1
* Update containerd to 2.2.1
* Update nerdctl to 2.2.1
* Update BuildKit to 0.26.3
* Update WinCNI 0.3.3

== 3.1.0 (2025-11-03)

* Fix double backslash in PATH.
https://github.com/slonopotamus/stevedore/issues/81[#81]
* Update Docker Engine to 28.5.1
* Update Docker Buildx to 0.29.1
* Update Docker Compose to 2.40.3
* Update docker-credential-wincred to 0.9.4
* Update containerd to 2.1.4
* Update nerdctl to 2.1.6
* Update BuildKit to 0.25.1

== 3.0.1 (2025-07-28)

* Temporarily revert to `com.docker.hcsshim.v1` runtime by default.
https://github.com/slonopotamus/stevedore/issues/80[#80]
* Fix progress text in installer
