...
* Fix ERROR_ALIAS_EXISTS error when installing as AD user. {uri-project}/issues/10[#10]
* Add Windows Server 2016 to list of supported OSes
* Enable Hyper-V Windows feature when Stevedore is installed for https://docs.microsoft.com/en-us/virtualization/windowscontainers/manage-containers/hyperv-container#hyper-v-isolation[Hyper-V container isolation]
